...
std::string ConfigMetadata::getVersionCVersion() const { return m_version_c_version; }

void ConfigMetadata::setVersionCVersion(const std::string& version_c_version) {
    m_version_c_version = version_c_version;
}

uint8_t ConfigMetadata::getVersionMajorVersionNumber() const { return m_version_major_version_number; }
...
uint8_t ConfigMetadata::getVersionMinorVersionNumber() const { return m_version_minor_version_number; }
...
uint8_t ConfigMetadata::getVersionReleaseNumber() const { return m_version_release_number; }
...
uint16_t ConfigMetadata::getModificationTimeDate() const { return m_modification_time_date; }
...
uint32_t ConfigMetadata::getModificationTimeTime() const { return m_modification_time_time; }
...
uint16_t ConfigMetadata::getTransferTimeDate() const { return m_transfer_time_date; }

void ConfigMetadata::setTransferTimeDate(const uint16_t& transfer_time_date) {
    m_transfer_time_date = transfer_time_date;
}

uint32_t ConfigMetadata::getTransferTimeTime() const { return m_transfer_time_time; }

void ConfigMetadata::setTransferTimeTime(const uint32_t& transfer_time_time) {
    m_transfer_time_time = transfer_time_time;
}

uint32_t ConfigMetadata::getAppChecksum() const { return m_app_checksum; }

void ConfigMetadata::setAppChecksum(const uint32_t& app_checksum) { m_app_checksum = app_checksum; }

uint32_t ConfigMetadata::getOverallChecksum() const { return m_overall_checksum; }

void ConfigMetadata::setOverallChecksum(const uint32_t& overall_checksum) { m_overall_checksum = overall_checksum; }

std::vector<uint32_t> ConfigMetadata::getIntegrityHash() const { return m_integrity_hash; }
